...
def NAS_FPN(cfg, input_shape: ShapeSpec):
    ...
    cell_inputs = cfg.BACKBONE.NAS_FPN.CELL_INPUTS
    ...
    backbone = NASFPNBase(
        ...
        cell_ops=cell_ops,
        nas_outputs=cfg.BACKBONE.NAS_FPN.NAS_OUTPUTS,
    )
    return backbone