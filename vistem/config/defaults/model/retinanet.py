...
_RETINANET.LOSS = CN()
_RETINANET.LOSS.FOCAL_LOSS_GAMMA = 2.0
_RETINANET.LOSS.FOCAL_LOSS_ALPHA = 0.25
_RETINANET.LOSS.SMOOTH_L1_LOSS_BETA = 0.1
...
_RETINANET.TEST.TOPK_CANDIDATES_TEST = 1000
_RETINANET.TEST.NMS_THRESH_TEST = 0.5